...
public class ClanManager {
	...
	private static final String SAVE_DIRECTORY = "./Data/clan/";
	...
	public void delete(Clan paramClan) {
		...
		File localFile = new File(SAVE_DIRECTORY + paramClan.getFounder() + ".cla");
		if (localFile.delete()) {
	...
	private Clan read(String paramString) {
		Misc.createDirectory(SAVE_DIRECTORY);
		File localFile = new File(SAVE_DIRECTORY + paramString + ".cla");
		if (!localFile.exists()) {
			return null;
		}
		try {
