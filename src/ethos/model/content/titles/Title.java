...
public enum Title implements Comparator<Title> {
	...
	SUPER_DONOR("Super", 0, TitleCurrency.NONE, new TitleRequirement() {
		@Override
		public boolean meetsStandard(Player player) {
			return player.getRights().isOrInherits(Right.SUPER_DONOR);
		}
	}, "This title is for a SUPER DONOR. You must be a SUPER DONOR to purchase and display this title."),
	...
	ULTRA_DONATOR("Ultra", 0, TitleCurrency.NONE, new TitleRequirement() {
		@Override
		public boolean meetsStandard(Player player) {
			return player.getRights().isOrInherits(Right.ULTRA_DONATOR);
		}
	}, "This title is for Ultra Donators. You must be a Ultra Donator to purchase and display this title."),
	...
	PLATINUM("Platinum", 0, TitleCurrency.NONE, new TitleRequirement() {
		@Override
		public boolean meetsStandard(Player player) {
			return player.getRights().isOrInherits(Right.PLATINUM);
		}
	}, "This title is for PLATINUM only. You must be in the PLATINUM to purchase and display this title."),
	DIVINE("Divine", 0, TitleCurrency.NONE, new TitleRequirement() {
		@Override
		public boolean meetsStandard(Player player) {
			return player.getRights().isOrInherits(Right.DIVINE);
		}
	}, "This title is for DIVINE only. You must be in the DIVINE to purchase and display this title."),
