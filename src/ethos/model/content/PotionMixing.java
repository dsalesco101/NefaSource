...
public class PotionMixing {
	...
	public enum Potion {
		AGILITY(3032, 3034, 3036, 3038), ANTI_VENOM(12905, 12907, 12909, 12911), ANTI_VENOM_PLUS(12913, 12915, 12917, 12919), ANTIDOTE_PLUS(5943, 5945, 5947,
				5949), ANTIDOTE_PLUS_PLUS(5952, 5954, 5956, 5958), ANTIFIRE(2452, 2454, 2456, 2458), SUPER_ANTIFIRE(21978, 21981, 21984, 21987), ANTIPOISON(2446, 175, 177, 179), ATTACK(2428, 121, 123, 125), COMBAT(9739,
