		...
		ROGUE(10, new KillstreakReward(2) {
			...
			public void append(Player player) {
				if (player.inClanWars() || player.inClanWarsSafe()) {
					if (!player.getItems().addItem(2996, 2)) {
						Server.itemHandler.createGroundItem(player, 2996, player.getX(), player.getY(), player.heightLevel, 2);
						player.sendMessage("You are on a 2 killstreak, you have been given 2 pkp.");
					}
				} else {
			...
			public void append(Player player) {
				if (player.inClanWars() || player.inClanWarsSafe()) {
					if (!player.getItems().addItem(2996, 3)) {
						Server.itemHandler.createGroundItem(player, 2996, player.getX(), player.getY(), player.heightLevel, 3);
						player.sendMessage("You are on a 3 killstreak, you have been given 2 pkp.");
					}
				} else {
			...
			public void append(Player player) {
				if (player.inClanWars() || player.inClanWarsSafe()) {
					if (!player.getItems().addItem(2996, 4)) {
						Server.itemHandler.createGroundItem(player, 2996, player.getX(), player.getY(), player.heightLevel, 4);
						player.sendMessage("You are on a 4 killstreak, you have been given 4 pkp.");
					}
				} else {
			...
			public void append(Player player) {
				if (player.inClanWars() || player.inClanWarsSafe()) {
					if (!player.getItems().addItem(2996, 5)) {
						Server.itemHandler.createGroundItem(player, 2996, player.getX(), player.getY(), player.heightLevel, 5);
						player.sendMessage("You are on a 5 killstreak, you have been given 5 pkp.");
					}
				} else {
			...
			public void append(Player player) {
				if (player.inClanWars() || player.inClanWarsSafe()) {
					if (!player.getItems().addItem(2996, 6)) {
						Server.itemHandler.createGroundItem(player, 2996, player.getX(), player.getY(), player.heightLevel, 6);
						player.sendMessage("You are on a 6 killstreak, you have been given 6 pkp.");
					}
				} else {
			...
			public void append(Player player) {
				if (player.inClanWars() || player.inClanWarsSafe()) {
					if (!player.getItems().addItem(2996, 7)) {
						Server.itemHandler.createGroundItem(player, 2996, player.getX(), player.getY(), player.heightLevel, 7);
						player.sendMessage("You are on a 7 killstreak, you have been given 7 pkp.");
					}
				} else {
			...
			public void append(Player player) {
				if (player.inClanWars() || player.inClanWarsSafe()) {
					if (!player.getItems().addItem(2996, 10)) {
						Server.itemHandler.createGroundItem(player, 2996, player.getX(), player.getY(), player.heightLevel, 10);
						player.sendMessage("You are on a 10 killstreak, you have been given 10 pkp.");
					}
				} else {
			...
			public void append(Player player) {
				if (player.inClanWars() || player.inClanWarsSafe()) {
					if (!player.getItems().addItem(2996, 12)) {
						Server.itemHandler.createGroundItem(player, 2996, player.getX(), player.getY(), player.heightLevel, 12);
						player.sendMessage("You are on a 12 killstreak, you have been given 12 pkp.");
					}
				} else {
			...
			public void append(Player player) {
				if (player.inClanWars() || player.inClanWarsSafe()) {
					if (!player.getItems().addItem(2996, 15)) {
						Server.itemHandler.createGroundItem(player, 2996, player.getX(), player.getY(), player.heightLevel, 15);
						player.sendMessage("You are on a 15 killstreak, you have been given 15 pkp.");
					}
				} else {
