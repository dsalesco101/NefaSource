	...
	public enum Stage {
		START(0, new Scene() {
			...
			public void display(Player player) {
				...
				String loc = "./data/tradingpost/players/" +player.playerName + ".txt";
			...
			public void display(Player player) {
				...
				player.sendMessage("@blu@Join ::discord for latest updates! and check out ::hccontest for prizes!");
			...
			public void display(Player player) {
				if (player.getMode().isIronman()) {
					...
					player.getItems().wearItem(1323, 1, player.playerWeapon);
					player.getItems().addItem(1171, 1);
					player.getItems().addItem(380, 50);
					player.getItems().addItem(841, 1);
					player.getItems().addItem(882, 50);
					player.getItems().addItem(556, 50);
					player.getItems().addItem(558, 50);
					player.getItems().addItem(555, 50);
					player.getItems().addItem(557, 50);
					player.getItems().addItem(559, 50);
					player.getItems().addItem(554, 50);
					player.getItems().addItem(563, 50);
					player.getItems().addItem(1381, 1);
		            PlayerHandler.executeGlobalMessage("[@blu@New Player@bla@] " + Misc.capitalizeJustFirst(player.playerName) + " @bla@has logged in! Welcome!");
			...
			public void display(Player player) {
				...
				} else if (player.getMode().isRegular()) {
