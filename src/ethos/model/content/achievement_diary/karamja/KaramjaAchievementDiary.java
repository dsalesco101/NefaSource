...
public final class KaramjaAchievementDiary extends StatefulAchievementDiary<KaramjaDiaryEntry>{
	...
	public static final Set<KaramjaDiaryEntry> EASY_TASKS = EnumSet.of(PICK_BANANAS, TELEPORT_TO_KARAMJA, SAIL_TO_ARDOUGNE, FISH_LOBSTER_KAR);
	
	public static final Set<KaramjaDiaryEntry> MEDIUM_TASKS = EnumSet.of(DURADEL, STEEL_DRAGON, DANCE_75_TIMES);
