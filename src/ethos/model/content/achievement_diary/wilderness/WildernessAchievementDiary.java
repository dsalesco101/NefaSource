...
public final class WildernessAchievementDiary extends StatefulAchievementDiary<WildernessDiaryEntry>{
	...
	public static final Set<WildernessDiaryEntry> ELITE_TASKS = EnumSet.of(CALLISTO, VENENATIS, VETION, DARK_CRAB, SMITH_RUNE_SCIM_WILD, SPIRITUAL_MAGE, MAGIC_LOG_WILD);
