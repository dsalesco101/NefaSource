...
public final class DesertAchievementDiary extends StatefulAchievementDiary<DesertDiaryEntry>{
	...
	public static final Set<DesertDiaryEntry> MEDIUM_TASKS = EnumSet.of(KILL_BANDIT,PASS_GATE_ROBES,COMBAT_POTION,CHOP_TEAK,PICKPOCKET_THUG,TRAVEL_NARDAH,KILL_VULTURE);
