...
public final class MorytaniaAchievementDiary extends StatefulAchievementDiary<MorytaniaDiaryEntry>{
	...
	public static final Set<MorytaniaDiaryEntry> EASY_TASKS = EnumSet.of(MAZCHNA, KILL_BANSHEE, KILL_WEREWOLF);
	...
	public static final Set<MorytaniaDiaryEntry> ELITE_TASKS = EnumSet.of(BARROWS_CHEST, KILL_ABYSSAL_DEMON);
