		...
		if (c.potionTimer.elapsed() > 1200) {
			...
			case 3046:
				if (c.breakVials == true) {
					drinkMagicPotion(itemId, -1, slot, 6, false);
					break;
				}
			...
			case 6691:
				if (c.breakVials == true) {
					drinkSaradominBrew(itemId, -1, slot);
					break;
				}
			...
			case 193:
				if (c.breakVials == true) {
					drinkZamorakBrew(itemId, -1, slot);
					break;
				}
			...
			case 149:
				if (c.breakVials == true) {
					drinkStatPotion(itemId, -1, slot, 0, true);
					break;
				}
			...
			case 161:
				if (c.breakVials == true) {
					drinkStatPotion(itemId, -1, slot, 2, true);
					break;
				}
			...
			case 173:
				if (c.breakVials == true) {
					drinkStatPotion(itemId, -1, slot, 4, false);
					break;
				}
			...
			case 137:
				if (c.breakVials == true) {
					drinkStatPotion(itemId, -1, slot, 1, false);
					break;
				}
			...
			case 119:
				if (c.breakVials == true) {
					drinkStatPotion(itemId, -1, slot, 2, false);
					break;
				}
			...
			case 125:
				if (c.breakVials == true) {
					drinkStatPotion(itemId, -1, slot, 0, false);
					break;
				}
			...
			case 167:
				if (c.breakVials == true) {
					drinkStatPotion(itemId, -1, slot, 1, true);
					break;
				}
			...
			case 3030:
				if (c.breakVials == true) {
					drinkSuperRestorePot(itemId, -1, slot);
					break;
				}
			...
			case 3038:
				if (c.breakVials == true) {
					drinkStatPotion(itemId, -1, slot, 16, 3);
					break;
				}
			...
			case 179:
				if (c.breakVials == true) {
					drinkAntiPoison(itemId, -1, slot, 200);
					break;
				}
			...
			case 185:
				if (c.breakVials == true) {
					drinkAntiPoison(itemId, -1, slot, 600);
					break;
				}
			...
			case 5949:
				if (c.breakVials == true) {
					drinkAntidote(itemId, -1, slot, 518);
					break;
				}
			...
			case 5958:
				if (c.breakVials == true) {
					drinkAntidote(itemId, -1, slot, 1200);
					break;
				}
			...
			case 9745:
				if (c.breakVials == true) {
					drinkCombatPotion(itemId, -1, slot);
					break;
				}
			...
			case 12631:
				...
				break;
			case 21978:
				drinkSuperAntifire(21981, slot, TimeUnit.MINUTES.toMillis(6));
				break;
			case 21981:
				drinkSuperAntifire(21984, slot, TimeUnit.MINUTES.toMillis(6));
				break;
			case 21984:
				drinkSuperAntifire(21987, slot, TimeUnit.MINUTES.toMillis(6));
				break;
			case 21987:
				drinkSuperAntifire(229, slot, TimeUnit.MINUTES.toMillis(6));
				break;
			case 2452:
