...
import ethos.model.players.skills.slayer.TaskExtension;
...
public class PlayerSave {
	...
	public static final int ERROR_OCCURRED_WHILE_LOADING = 77;

	public static final String SAVE_DIRECTORY = "./Data/characters/";
	...
	public static boolean playerExists(String name) {
		Misc.createDirectory(SAVE_DIRECTORY);
	...
	public static int loadGame(Player p, String playerName, String playerPass) {
		...
		while (EndOfFile == false && line != null) {
			...
			try {
				...
				if (spot > -1) {
					...
					case 2:
						if (token.equals("character-height")) {
							...
							p.teleportToX = p.tourneyX = (Integer.parseInt(token2) <= 0 ? 3210 : Integer.parseInt(token2));
						} else if (token.equals("character-posy")) {
							p.teleportToY = p.tourneyY = (Integer.parseInt(token2) <= 0 ? 3424 : Integer.parseInt(token2));
							...
							p.exchangeP = (Integer.parseInt(token2));
							...
							p.pages = Integer.parseInt(token2);
						} else if (token.equals("ether")) {
							p.ether = Integer.parseInt(token2);
						} else if (token.equals("crawsbowCharge")) {
							p.crawsbowCharge = Integer.parseInt(token2);
							...
							p.RefU = Integer.parseInt(token2);
						} else if (token.equals("RefP")) {
							p.RefP = Integer.parseInt(token2);
						} else if (token.equals("LoyP")) {
							p.LoyP = Integer.parseInt(token2);
						} else if (token.equals("votePoints")) {
							p.votePoints = Integer.parseInt(token2);
						} else if (token.equals("dayv")) {
							p.dayv = Integer.parseInt(token2);
						...
						} else if (token.equals("memberdays")) {
							p.memberdays = Integer.parseInt(token2);
							...
							p.christmasEvent = Boolean.parseBoolean(token2);
							...
							//Varrock claimed
						}else if (token.equals("d1Complete")) {
						...
						} else if (token.equals("combat-level-back-up")) {
							for (int j = 0; j < token3.length; j++) {
								p.combatLevelBackUp[j] = Integer.parseInt(token3[j]);
							}
					...
					case 17:
						try {
							...
							if (Server.getConfiguration().getServerState() == ServerState.PRIVATE) {
								e.printStackTrace();
							}
						}
						break;
				...
				log.severe("An error occured while reading [" + playerName + "] character file on line: " + line);
				e.printStackTrace();
				return ERROR_OCCURRED_WHILE_LOADING;
			}
		}
		try {
			characterfile.close();
	...
	public static boolean saveGame(Player p) {
		...
		try {
			...
			characterfile.write("combat-level-back-up = ", 0, 23);
			String toWriteX = "";
			for(int i1 = 0; i1 < p.combatLevelBackUp.length; i1++) {
				toWriteX += p.combatLevelBackUp[i1] +"\t";
			}
			characterfile.write(toWriteX);
			characterfile.newLine();
			...
			characterfile.write("changedmac = ", 0, 13);
			characterfile.write(Boolean.toString(p.changedmac), 0, Boolean.toString(p.changedmac).length());
			characterfile.newLine();
			characterfile.write("exchangeP = ", 0, 12);
			characterfile.write(Integer.toString(p.exchangeP), 0, Integer.toString(p.exchangeP).length());
			characterfile.newLine();
			...
			characterfile.newLine();
			characterfile.write("elvenCharge = ", 0, 13);
			characterfile.write(Integer.toString(p.elvenCharge), 0, Integer.toString(p.elvenCharge).length());
			characterfile.newLine();
			characterfile.write("pages = ", 0, 8);
			characterfile.write(Integer.toString(p.pages), 0, Integer.toString(p.pages).length());
			characterfile.newLine();
			characterfile.write("ether = ", 0, 7);
			characterfile.write(Integer.toString(p.ether), 0, Integer.toString(p.ether).length());
			characterfile.newLine();
			characterfile.write("crawsbowCharge = ", 0, 17);
			characterfile.write(Integer.toString(p.crawsbowCharge), 0, Integer.toString(p.crawsbowCharge).length());
			characterfile.newLine();
			characterfile.write("thammaronCharge = ", 0, 18);
			characterfile.write(Integer.toString(p.thammaronCharge), 0, Integer.toString(p.thammaronCharge).length());
			characterfile.newLine();
			characterfile.write("viggoraCharge = ", 0, 16);
			...
			characterfile.newLine();
			characterfile.write("tPoint = ", 0, 9);
			characterfile.write(Integer.toString(p.tPoint), 0, Integer.toString(p.tPoint).length());
			characterfile.newLine();
			...
			characterfile.write(Integer.toString(p.RefU), 0, Integer.toString(p.RefU).length());
			characterfile.newLine();
			characterfile.write("RefP = ", 0, 6);
			characterfile.write(Integer.toString(p.RefP), 0, Integer.toString(p.RefP).length());
			characterfile.newLine();
			characterfile.write("LoyP = ", 0, 6);
			characterfile.write(Integer.toString(p.LoyP), 0, Integer.toString(p.LoyP).length());
			characterfile.newLine();
			characterfile.write("dayv = ", 0, 6);
			characterfile.write(Integer.toString(p.dayv), 0, Integer.toString(p.dayv).length());
			characterfile.newLine();
			...
			characterfile.newLine();
			characterfile.write("memberdays = ", 0, 13);
			characterfile.write(Integer.toString(p.memberdays), 0, Integer.toString(p.memberdays).length());
			characterfile.newLine();
			...
			characterfile.newLine();
			characterfile.write("christmasEvent = ", 0, 16);
			characterfile.write(Boolean.toString(p.christmasEvent), 0, Boolean.toString(p.christmasEvent).length());
			characterfile.newLine();
