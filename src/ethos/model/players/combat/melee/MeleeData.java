...
public class MeleeData {
	...
	public static int getAttackDelay(Player c, String s) {
		...
		switch (c.playerEquipment[c.playerWeapon]) {
		case 12926:
			return c.playerAttackingIndex > 0 ? 4 : 3;
		case 12765:
		case 12766:
		case 12767:
		case 12768:
		...
		if (s.endsWith("greataxe"))
			...
			if (s.contains("composite") || s.equals("seercull"))
				...
				return 6;
			return 5;
		} else if (s.contains("dagger") || s.contains("Cudgel") || s.contains("arclight"))
			return 4;
			...
			return 6;
		else if (s.contains("whip") || s.contains("tentacle") || s.contains("abyssal bludgeon") || s.contains("rapier") )
			return 4;
