...
public class Farming {
	...
	public static final int MAX_PATCHES = 12;
...
/*				if (id >= 4 && player.amountDonated < 150) {
	...
	public void farmPoisonBerry() {
		if (System.currentTimeMillis() - lastPoisonBerryFarm < TimeUnit.SECONDS.toMillis(45)) {
			player.sendMessage("You can only pick berries from this bush every 45 seconds.");
			return;
		}
	...
	enum Patch {
		...
		DONATOR1(4, 3820, 2834),
		DONATOR2(5, 3820, 2836),
		DONATOR3(6, 3822, 2834),
		DONATOR4(7, 3822, 2836),
		DONATOR5(8, 3824, 2834),
		DONATOR6(9, 3824, 2836);
