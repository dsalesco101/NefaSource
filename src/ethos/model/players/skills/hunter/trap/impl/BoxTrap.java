...
//			}
	...
	private enum BoxTrapData {
		FERRET(1505, 27, 115, new GameItem(10092, 2)),
		CHINCHOMPA(2910, 53, 198.25, new GameItem(10033, 2)),
		CARNIVOROUS_CHINCHOMPA(2911, 63, 265, new GameItem(10034, 2)),
		BLACK_CHINCHOMPA(2912, 73, 335, new GameItem (11959, 2));
