...
public enum Potion {
	...
	ANTI_VENOM(new GameItem(12905), 87, 120, new GameItem(5954), new GameItem(12934, 20)), 
	ANTI_VENOM_PLUS(new GameItem(12913), 94, 125, new GameItem(12907), new GameItem(219)), 
	...
	SUPER_ANTIFIRE(new GameItem(21978), 92, 130, new GameItem(2452), new GameItem(21975)), 
