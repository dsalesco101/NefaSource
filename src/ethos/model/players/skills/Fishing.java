...
public class Fishing extends SkillHandler {
	...
	public static int[][] data = { 
			...
			{ 7, 35, 21028, -1, 359, 80, 7401, 371, 50, 100, 32300 }, // TUNA + SWORDIE
			{ 7, 35, 21031, -1, 359, 80, 7402, 371, 50, 100, 32300 }, // TUNA + SWORDIE
			...
			{ 10, 76, 21028, -1, 383, 110, 7401, -1, -1, -1, 31200 }, // SHARK
			{ 10, 76, 21031, -1, 383, 110, 7402, -1, -1, -1, 31200 }, // SHARK
			...
			{ 14, 1, -1, -1, 3150, 1, 620, -1, -1, -1, 32900 }, // Karambwanji AFK FISH
			{ 15, 65, 3159, 3150, 3142, 105, 620, -1, -1, -1, 30200 }, // Karambwan
			...
			if (npcId == data[i][0]) {
				...
				CycleEventHandler.getSingleton().addEvent(player, new CycleEvent() {
					...
					public void execute(CycleEventContainer container) {
						...
						if (Misc.random(150) == 0 && player.getInterfaceEvent().isExecutable()) {
						...
						if (player.playerSkillProp[10][1] > 0) {
							...
							if (Misc.random(12000) == 5555) {
							 ...
							 if (Misc.random(player.playerSkillProp[10][10]) == 2 && player.getItems().getItemCount(13320, true) == 0 && player.summonId != 13320) {
								 PlayerHandler.executeGlobalMessage("[<col=CC0000>News</col>] <col=255>" + player.playerName + "</col> caught a fish and a <col=CC0000>Heron</col> pet!");
