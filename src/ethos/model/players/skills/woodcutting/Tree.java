...
public enum Tree {
	...
	WILLOW(new int[] { 10833, 1760, 1750, 1758, 11759, 11761, 11763, 11755 }, 1356, 1519, 30, 10, 60, 68, 35, 11000), 
	TEAK(new int[] { 9036 }, 1356, 6333, 35, 10, 65, 68, 35, 10500), 
	MAPLE(new int[] { 10832, 11762 }, 1356, 1517, 45, 13, 75, 100, 45, 10000), 
	ARCTIC_PINE(new int[] { 3037 }, 1356, 10810, 54, 14, 85, 100, 50, 90400),
	YEW(new int[] { 10822, 1754, 11758, 27255 }, 1356, 1515, 60, 15, 100, 175, 60, 9000),
	MAGIC(new int[] { 10834, 11764 }, 9713, 1513, 75, 20, 125, 250, 75, 8600), 
	REDWOOD(new int[] { 29668, 29670 }, 29669, 19669, 90, 35, 125, 275, 150, 8400),
