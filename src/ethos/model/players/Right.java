...
public enum Right implements Comparator<Right> {
	...
	public static final Right[] PRIORITY = { PLAYER, OSRS, HC_IRONMAN, IRONMAN, ULTIMATE_IRONMAN, MEMBERSHIP, TRIAL_DONATOR, REGULAR_DONATOR, SUPER_DONOR, EXTREME_DONOR, ULTRA_DONATOR, LEGENDARY_DONATOR, DIAMOND_CLUB, ONYX_CLUB, PLATINUM, DIVINE, YOUTUBER, HITBOX, HELPER,
