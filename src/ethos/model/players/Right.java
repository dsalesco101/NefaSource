...
public enum Right implements Comparator<Right> {
	...
	public static final EnumSet[] DISPLAY_GROUPS = {
			...
			EnumSet.of(HITBOX, IRONMAN, ULTIMATE_IRONMAN, YOUTUBER, GAME_DEVELOPER, OSRS, MED_MODE, TRIAL_DONATOR, HC_IRONMAN)
	};

	/**
	 * Donator rights.
	 */
	public static final EnumSet<Right> DONATOR_SET = EnumSet.of(REGULAR_DONATOR, SUPER_DONOR, EXTREME_DONOR, ULTRA_DONATOR, LEGENDARY_DONATOR, DIAMOND_CLUB, ONYX_CLUB, PLATINUM, DIVINE);
	...
	public static final Right[] PRIORITY = { PLAYER, OSRS, HC_IRONMAN, IRONMAN, ULTIMATE_IRONMAN, MED_MODE, TRIAL_DONATOR, REGULAR_DONATOR, SUPER_DONOR, EXTREME_DONOR, ULTRA_DONATOR, LEGENDARY_DONATOR, DIAMOND_CLUB, ONYX_CLUB, PLATINUM, DIVINE, YOUTUBER, HITBOX, HELPER,
