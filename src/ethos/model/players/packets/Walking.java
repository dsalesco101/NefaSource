...
//		}
		...
		if (c.teleTimer > 0) {
			if (PlayerHandler.players[c.playerAttackingIndex] != null
					&& c.goodDistance(c.getX(), c.getY(), PlayerHandler.players[c.playerAttackingIndex].getX(), PlayerHandler.players[c.playerAttackingIndex].getY(), 1) && packetType != 98) {
				c.playerAttackingIndex = 0;
			} else {
				// c.sendMessage("Stop.");
				if (packetType != 98) {
...
//		if (c.getUltraInterface().isActive()) {	
//			//c.inDonatorBox = true;
//			c.getPA().showInterface(47000);
//			c.sendMessage("@red@[WARNING] @blu@Please do not interrupt or you @red@WILL@blu@ lose items! @red@NO REFUNDS");
//			//c.getUltraInterface().draw();
//			return;
//		}
//		if (c.getNormalBoxInterface().isActive()) {	
//			//c.inDonatorBox = true;
//			c.getPA().showInterface(47000);
//			c.sendMessage("@red@[WARNING] @blu@Please do not interrupt or you @red@WILL@blu@ lose items! @red@NO REFUNDS");
//			//c.getNormalBoxInterface().draw();
//			return;
//		}
//		if (c.getSuperBoxInterface().isActive()) {	
//			//c.inDonatorBox = true;
//			c.getPA().showInterface(47000);
//			c.sendMessage("@red@[WARNING] @blu@Please do not interrupt spin or you @red@WILL@blu@ lose items! @red@NO REFUNDS");
//			//c.getSuperBoxInterface().draw();
//			return;
//		}
		...
		if (Misc.distance(c.absX, c.absY, pathX, pathY) < 35) {
			//System.out.println("walk to " + pathX + " " + pathY);
