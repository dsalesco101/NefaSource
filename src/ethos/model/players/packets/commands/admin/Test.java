...
import ethos.model.players.combat.monsterhunt.MonsterHuntLocation;
import ethos.model.players.combat.monsterhunt.MonsterHunt.Npcs;
...
public class Test extends Command {
	...
	private enum RankUpgrade {
		TRIAL_DONATOR(Right.TRIAL_DONATOR, 5),
		REGULAR_DONATOR(Right.REGULAR_DONATOR, 10), 
		SUPER_DONOR(Right.SUPER_DONOR, 50), 
		EXTREME_DONOR(Right.EXTREME_DONOR, 100), 
		ULTRA_DONATOR(Right.ULTRA_DONATOR, 200), 
		LEGENDARY_DONATOR(Right.LEGENDARY_DONATOR, 300), 
		DIAMOND_CLUB(Right.DIAMOND_CLUB, 500), 
		ONYX_CLUB(Right.ONYX_CLUB, 1000),
		PLATINUM(Right.PLATINUM, 2500),
		DIVINE(Right.DIVINE, 5000);
