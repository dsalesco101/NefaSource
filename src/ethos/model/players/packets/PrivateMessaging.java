...
public class PrivateMessaging implements PacketType {
	...
	public void processPacket(Player c, int packetType, int packetSize) {
		...
		case SEND_PM:
			...
			Player other = PlayerHandler.getPlayerByLongName(recipient);
			String name = null;
			if (other != null) {
				name = other.playerName;
			}
			PlayerLogging.write(LogType.PRIVATE_CHAT, c, "Recipient = " + name + ", message = " + Misc.decodeMessage(pm_chat_message, pm_chat_message.length));
			break;
