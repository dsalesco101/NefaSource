...
public class NPC extends Entity {
	...
	public int projectileId, endGfx, spawnedBy, hitDelayTimer, hitDiff, actionTimer, enemyX, enemyY;
	...
	public void moveTowards(int x, int y) {
		moveX = Server.npcHandler.GetMove(absX, x);
		moveY = Server.npcHandler.GetMove(absY, y);
		if (moveX != 0 || moveY != 0) {
			updateRequired = true;
			getNextNPCMovement();
		}
	...
	public boolean inMulti() {
		if (Boundary.isIn(this, Zulrah.BOUNDARY) || Boundary.isIn(this, Boundary.CORPOREAL_BEAST_LAIR)
				...
				|| Boundary.isIn(this, Boundary.ICE_DEMON) || Boundary.isIn(this, Boundary.CATACOMBS)|| Boundary.isIn(this,Boundary.REV_CAVE)) {
			return true;
		}
	 ...
	 * 
	 * @return the {@link NPCDefinitions} object associated with this NPC
	 */
