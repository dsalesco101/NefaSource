...
public class Vorkath {
	...
	public static int[][] uncommonDrops = { { 21975, 2 }, { 21338, 27 + Misc.random(3) }, { 21930, 55 + Misc.random(45) },
			...
			{ 9193, 7 + Misc.random(21) }, { 9194, 5 + Misc.random(5) }, { 9194, 26 + Misc.random(4) }, { 21880, 30 + Misc.random(70) },
			{ 824, 86 + Misc.random(14) }, { 11232, 15 + Misc.random(40) }, { 11237, 27 + Misc.random(23) },
	...
	public static ArrayList<GameItem> getVeryRareDrops() {
		...
		for(int i = 0; i < veryRareDrops.length; i++) {
			drops.add(new GameItem(veryRareDrops[i][0], 1));
		}
	...
	public static void drop(Player player) {
		...
		if (roll == 1) {
			...
			player.getCollectionLog().handleDrop(8028, rareDrops[veryRareItemRoll][0], rareDrops[veryRareItemRoll][1]);
