...
public class Item {
	...
	public static int hats[] = { 3057, 20838, 2679, 2685, 2682, 2703, 2688, 2691, 2691, 2733, 2736, 2718, 2730, 2697, 2715,
			...
			10547, 10548, 10608, 10802, 10804, 10806, 10941, 11280, 12419, 12457, 13876, 7112, 7124, 21890, 21888 };
	...
	public static int legs[] = { 10438, 10434, 20842, 10430, 10426, 10422, 10418, 10414, 10410, 10406, 10402, 7609, 2522, 7378,
			...
			7398, 7386, 6324, 6343, 6353, 7116, 7126, 7132, 7134, 3387, 5036, 5038, 5040, 13873, 22328, 22725, 20842, 22723,
			 22729};
	...
	public static int platebody[] = { 12277, 12235, 12205, 11020, 13887, 13884, 13858, 10551, 10338, 7608, 2520, 430,
			...
			5034, 7392, 1035,577, 22327, 20840, 22700, 22722, 22728, 23975};
	...
	private static String[] fullbody = { "platebody", "plate", "top", "wings", "blouse", "monk's robe", "shirt",
			...
			"Justiciar chestguard", "Vesta chainbody", "Zuriel's Leather Top", "Morrigans's Robe Top", "Crystal Body",
			"Dragonstone Platebody", "Corrupted Body", "3rd age druidic top"
	...
	private static String[] fullhat = { "splitbark helm", "mystic", "black mask", "highwayman mask", "mime mask",
			...
			"Dharok's helm", "hood", "Zuriel's Hood", "Initiate helm", "Coif", "Helm of neitiznot", "Armadyl helmet", "Berserker helm",
			...
			"3rd age full helmet", "dwarven helmet", "kandarin headgear", "camo", "Morrigan's Coif"
	};
	...
	private static String[] fullmask = { "helm", "helmet_imbued", "helm_(g)", "Bronze_full_helm", "Iron_full_helm",
			...
			"Statius's helm", "Skeleton mask", "Turquoise slayer helmet", "Turquoise slayer helmet (i)", "Crystal Helm",
			"Dragonstone Full Helm", "Corrupted Helm", "Ornate Helm"
	};
	...
	public static boolean isFullMask(int itemId) {
		...
		if (weapon.contains("slayer helm"))
			return true;
		if (itemId == 21266 || itemId == 21888 || itemId == 21890) 
			return true;
...
//		}
	...
	static {
		...
		itemStackable[23933] = true;
		itemStackable[23877] = true;
